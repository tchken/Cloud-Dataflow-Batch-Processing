...
_STANDARDPTRANSFORMS_COMPOSITES = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COMBINE_GROUPED_VALUES', index=2, number=2,
...
_STANDARDCODERS_ENUM = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\242\264\372\302\005\027beam:coder:timestamp:v1')),
      type=None),
    _descriptor.EnumValueDescriptor(
...
_EXECUTABLESTAGEPAYLOAD = _descriptor.Descriptor(
  ...
  nested_types=[_EXECUTABLESTAGEPAYLOAD_SIDEINPUTID, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_STANDARDPTRANSFORMS_COMPOSITES.values_by_name["COMBINE_GROUPED_VALUES"].has_options = True
_STANDARDPTRANSFORMS_COMPOSITES.values_by_name["COMBINE_GROUPED_VALUES"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\242\264\372\302\005(beam:transform:combine_grouped_values:v1'))
...
_STANDARDCODERS_ENUM.values_by_name["TIMESTAMP"].has_options = True
_STANDARDCODERS_ENUM.values_by_name["TIMESTAMP"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\242\264\372\302\005\027beam:coder:timestamp:v1'))
