...
_RUNJOBREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='staging_token', full_name='org.apache.beam.model.job_management.v1.RunJobRequest.staging_token', index=1,
